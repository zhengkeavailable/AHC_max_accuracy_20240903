...
def AHC_optimization():
    ...
    paras = [
        ...
        # [1000 / 3810, 1000 / 3810, 0.96, 0.96, 0.96, rice_file_path, 100],
        # [1500 / 3810, 1500 / 3810, 0.96, 0.96, 0.96, rice_file_path, 100],
        # [500 / 3810, 500 / 3810, 0.97, 0.97, 0.97, rice_file_path, 100],
        # [1000 / 3810, 1000 / 3810, 0.97, 0.97, 0.97, rice_file_path, 100],
        # [1500 / 3810, 1500 / 3810, 0.97, 0.97, 0.97, rice_file_path, 100],
        # [500 / 3810, 500 / 3810, 0.98, 0.98, 0.98, rice_file_path, 100],
        # [1000 / 3810, 1000 / 3810, 0.98, 0.98, 0.98, rice_file_path, 100],
        # [1500 / 3810, 1500 / 3810, 0.98, 0.98, 0.98, rice_file_path, 100],
    ...
    for para in paras:
        ...
        full_mip_objective_value, full_mip_optimality_gap, full_mip_weights, full_mip_bias, full_mip_z_plus, full_mip_z_minus, full_mip_objective_function_term, full_mip_real_train_result, full_mip_buffered_train_result, full_mip_counts_result = full_MIP.full_mip(
            ...
            rho=rho,
            beta_p=full_mip_beta_p, lbd=lbd, dirname=full_mip_dirname, timelimit=full_mip_timelimit)
